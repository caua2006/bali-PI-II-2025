...
static const char* ASSET_BG_QUADRATICA = "C:/Users/renan/source/repos/BALI-PI/x64/Debug/assets/bg/quadratica.jpg";
...
static const char* ASSET_PLAYER_IDLE = "assets/sprites/player-walk-3.jpg";   // 4 frames animados
static const char* ASSET_PLAYER_WALK = "assets/sprites/player-walk-3.jpg";   // 4 frames (mesmo sprite)
...
static const char* ASSET_KEY = "assets/sprites/key.png";
static const char* ASSET_APPLE = "assets/sprites/apple.png";          // Se não existir, usa círculo vermelho
static const char* ASSET_APPLE_GOLD = "assets/sprites/apple-gold.png"; // Se não existir, usa círculo dourado
static const char* ASSET_ENEMY = "assets/sprites/enemy.png";          // Se não existir, usa quadrado
static const char* ASSET_OBSTACLE = "assets/sprites/obstacle.png";    // Se não existir, usa retângulo
 ...
 void game_draw(Game* game) {
    ...
    case STATE_PLAY: {
        ...
        for (int i = 0; i < phase->collectible_count; i++) {
            ...
            // Tamanho do sprite (baseado no radius)
            int sprite_size = (int)(c->radius * PIXELS_PER_UNIT * 2.5);  // Um pouco maior que o círculo
